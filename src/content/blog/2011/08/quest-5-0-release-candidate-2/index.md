---
title: "Quest 5.0 Release Candidate 2"
date: 2011-08-09
author: "Alex Warren"
categories: 
  - "quest"
...
Inevitably, a few bugs were logged against last week's Release Candidate 1, so I've now fixed them and uploaded a new Release Candidate 2, which you can [download here](http://www.textadventures.co.uk/quest/download/ "Download Quest").

The biggest bugs fixed were that the Exits tab wasn't showing existing exits, and a memory leak that could cause a hang after switching back and forth in the Code View after making edits. See the [issue tracker list](http://quest.codeplex.com/workitem/list/advanced?keyword=&status=Closed&type=All&priority=All&release=Quest%205.0%20Release%20Candidate%202&assignedTo=All&component=All&sortField=Id&sortDirection=Ascending&page=0) for full details.
...
Twitter: [@alexwarren](http://twitter.com/alexwarren)
