...
Games are assigned a category only after they've been checked by a moderator. This ensures that only games of a reasonable quality are given a category - a lot of uploads are quick test games or are incomplete, so these get assigned to the Sandpit category instead. However, as a game author you probably know best what category you would _like_ it to be in, so you can now specify one when you upload, and you can also suggest a new category if none of the existing ones fit.
