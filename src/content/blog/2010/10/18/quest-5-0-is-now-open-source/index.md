...
This wouldn't bother me too much if the user base for Quest was huge anyway. But writing your own text adventure games is a niche hobby, and there are a number of excellent free alternatives to Quest, most notably [Inform](http://inform7.com/).
...
You can find the Quest 5.0 project at CodePlex: [http://quest.codeplex.com](http://quest.codeplex.com)
...
If you think you can help, please [join up on the CodePlex page](http://quest.codeplex.com/). I've also added a page of [Developer Guidelines](http://quest5.net/index.php?title=Developers) to the wiki.
...
Get the code from CodePlex: [http://quest.codeplex.com](http://quest.codeplex.com)

Documentation is on the wiki: [http://quest5.net](http://quest5.net)
