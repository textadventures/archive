...
In April 2012 I marked a year of working on Quest full-time by conducting my own "Annual Review" ([Part 1](/blog/2012/04/03/a-year-of-full-time-questing-part-1), [Part 2](/blog/2012/04/04/a-year-of-full-time-questing-part-2-the-appraisal)). Well, er, 13 months have elapsed since then, which makes it the perfect time to do it all again.
...
- May saw the release of [Quest 5.2](/blog/2012/05/12/quest-5-2-is-out-now), which featured the new gamebook mode
- In June I presented Quest at the [CAS Conference](http://www.computingatschool.org.uk/index.php?id=conf2012)
- In July I ran [Quest workshops at Games Britannia](/blog/2012/07/04/quest-at-games-britannia)
- In September I chatted to Rob Pratten about Quest on the [Transmedia Podcast](/blog/2012/09/25/talking-about-quest-and-text-adventure-games-on-the-transmedia-podcast)
- In October I presented Quest at the [South West Learning Technologies conference](/blog/2012/09/17/quest-at-south-west-learning-technologies-conference), and ran [workshops at](/blog/2012/10/15/quest-workshops-at-gamecity-7) [GameCity](/blog/2012/10/15/quest-workshops-at-gamecity-7)
- In December I [spoke at AdventureX](http://screen7.co.uk/adventurex/2012/schedule.html) (the video of this is [now online](http://youtu.be/lQQbKt4_cKk)) and released the second Quest-powered smartphone and tablet app, [Escape from Byron Bay](/blog/2012/12/05/escape-from-byron-bay-now-available-for-iphone-and-ipad)
- January 2013 saw the [release of Quest 5.3](/blog/2013/01/14/quest-5-3-is-released), featuring a new map view, support for web fonts, and cover art. I also applied for some [funding from Nesta](http://www.nesta.org.uk/home1/assets/features/digital_makers_open_call_for_ideas) (which we didn't get)
- In February I presented Quest at the [Story Sharing Web Conference](http://www.britishcouncil.org/turkey-english-teaching-stories-for-schools-story-sharing-conference.htm) and released the third app - [Aventura Pirata](/blog/2013/02/06/spanish-adaptation-of-scott-adams-text-adventure-for-iphone-ipad-android)
- March saw the [release of](/blog/2013/03/28/quest-5-4-released) [Quest 5.4](/blog/2013/03/28/quest-5-4-released), bringing enhancements to gamebook mode and the new text processor making it easier to embed links and images within text. There was also the [launch of QuestComp](/blog/2013/03/13/questcomp-2013) and the release of the fourth app, [First Times](/blog/2013/03/13/first-times-a-horror-text-adventure-for-iphone-ipad-android)
- In April I launched the [revamped website](/blog/2013/04/20/the-new-textadventures-co-uk) and a [game about the elections in Pakistan](http://textadventures.co.uk/games/view/44yzyx1xykcy0sv4ycz9cg/its-election-time-in-pakistan-go-rich-boy-go) became a surprise hit
...
For smartphone and tablet apps, there has been a mixture of good and bad results. It's difficult to get publicity, so while there has been some good coverage - it was great to see [First Times](http://textadventures.co.uk/games/view/u4vzkxbzvkefhftiainh7a/first-times) listed as one of the Guardian's [30 best Android apps](http://www.guardian.co.uk/technology/appsblog/2013/mar/15/best-android-apps-real-boxing-messageme) of that week ...
...
... and it was also an [IndieGames freeware pick](http://indiegames.com/2013/03/freeware_mobile_pick_first_tim.html), but after an initial flurry the "long tail" is indeed long, and shallow. On iOS, First Times went from 2,280 downloads in March down to 252 in April - which is actually slightly less than the older app, [The Things That Go Bump In The Night](http://textadventures.co.uk/games/view/-hojesbi00cbfest89zong/the-things-that-go-bump-in-the-night), which had 313.

Even so this is much better than the sad tale of [Aventura Pirata](http://textadventures.co.uk/games/view/g6mkn43yskoalm1i45s69a/aventura-pirata), a Spanish-language game which only had 27 downloads on iOS in April.
...
[Adrian Camm says](http://adriancamm.com/post/20581116920/cloak-of-darkness-using-if-for-systems-thinking):
...
[Jon Bridgeman talks about using Quest with Year 7 and 8 students](http://talesfromthecastironshore.wordpress.com/2012/11/24/interactive-fiction-no-ifs-or-buts/):
...
(It's well worth your time reading his [full blog post](http://talesfromthecastironshore.wordpress.com/2012/11/24/interactive-fiction-no-ifs-or-buts/) on getting students into writing interactive fiction)
...
[FreewareGenius says](http://www.freewaregenius.com/create-a-text-adventure-and-publish-as-a-desktop-or-mobile-app-for-free-with-quest/):
...
[IndieGames says](http://indiegames.com/2012/10/indie_tools_quest.html):
...
Quest [even helped out at a party](http://www.geekyhostess.com/text-adventure-party/):

> Want to make your own text adventure game like Mr. Geek? You can use Quest, a free online program that makes it super easy!

Anybody got anything negative to say? To me, constructive criticism is more useful than a nice slap on the back. I've not actually seen much in the way of "bad press" this year, but one can always rely on forum member [davidw](http://forum.textadventures.co.uk/memberlist.php?mode=viewprofile&u=30) for a choice quote. Over on the [Adrift forum](http://forum.adrift.co/viewtopic.php?f=6&t=9110) he writes:
...
Being accessible is what allows a game like [Go Rich Boy Go](http://textadventures.co.uk/games/view/44yzyx1xykcy0sv4ycz9cg/its-election-time-in-pakistan-go-rich-boy-go) to exist in the first place. As the game's author [Jahanzaib Haque explains](http://jhaque.wordpress.com/2013/05/02/game-reviews-its-election-time-in-pakistan-go-rich-boy-go/):
...
The game was been played by thousands of people over just a few days. As [Global Voices](http://globalvoicesonline.org/2013/05/02/game-over-pakistans-young-and-rich-are-heading-to-the-polls/) covered it:
...
Over the last year, it seems interactive fiction has started to take its first steps towards the mainstream. We have companies like [Inkle](http://www.inklestudios.com/) releasing apps, and suddenly much talk about [Twine](http://www.gimcrackd.com/etc/src/). [Playfic](http://playfic.com/) brought Inform into the browser and new platforms like [Versu](http://www.versu.com/) emerged. Crazy ideas are being tried out - like combining text games with something like Pinterest to create [Dio](https://www.dio.com/). [StoryNexus](http://storynexus.com/s) is [powering a game](http://www.gamesindustry.biz/articles/2013-04-15-random-house-launches-free-to-play-game) from book publisher Random House which [features in-app payments](http://www.wired.co.uk/news/archive/2013-04/15/black-crown-interactive-fiction) allowing you to do things like "expedite the narrative". And check out the [Choosatron](http://choosatron.com/). Stuff is happening here.

I think Quest occupies a unique position among all this. It encompasses both typing-based "old-school" text adventure games with a parser, and a newer style which is emerging based on hyperlinks that is closer to "Choose Your Own Adventure" than "Zork". Will one style win over the other? Who knows - and I'm not going to be the one to prescribe exactly how people should interact with _your_ game. We're all still figuring this stuff out.

Perhaps more importantly, Quest is open source. Anybody can get involved in the project, contribute code or translations, or even fork the code if they don't like where it's heading - go ahead, build your own interactive fiction platform, even make it closed source and expensive if you want. You are allowed to do this by the [licence](https://quest.codeplex.com/license), and you'll save yourself a load of work.

The open source-ness also gives you security - Quest is not locked up inside one website, ready to disappear when a company runs out of money or their staff get acqui-hired. Even if [textadventures.co.uk](http://textadventures.co.uk) disappears or I spontaneously combust, the [source code for Quest](https://quest.codeplex.com/SourceControl/BrowseLatest) is available to be run somewhere else, and the games are all downloadable.

Finally, even though Quest is free, it is actively supported and maintained, and it is continuing to grow and explore new directions. Need help, or got a mad idea for a project where something like Quest might be useful? Get in touch - [alex@textadventures.co.uk](mailto:alex@textadventures.co.uk) or [@alexwarren](http://twitter.com/alexwarren).
