...
Well, I've been talking about my vision for the future of text adventures for a long time now - in previous blog posts such as [Text adventure games are still new](/blog/2013/01/text-adventure-games-are-still-new "Text adventure games are still new"), [Thoughts on interactive storytelling and The Hobbit](/blog/2012/12/thoughts-on-interactive-storytelling-and-the-hobbit "Thoughts on interactive storytelling and The Hobbit"), [Experimenting with stories and text](/blog/2013/04/experimenting-with-stories-and-text "Experimenting with stories and text"), and in [my talk at AdventureX](http://youtu.be/lQQbKt4_cKk). I realised that my thoughts would have a lot more weight if I backed them up by actually trying to create something, instead of just talking in the abstract about the kinds of experimentation that are still to be done with text-based games.
