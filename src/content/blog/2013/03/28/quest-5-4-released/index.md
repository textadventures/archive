...
The major new features in this version are the [text processor](/blog/2013/02/27/quest-5-4-text-processor-easier-adaptive-text-and-links), [gamebook scripts](/blog/2013/02/27/bringing-more-power-to-gamebook-mode-in-quest-5-4) and [script editor code view](/blog/2013/02/25/quest-5-4-script-editor-showing-you-teh-codez). For a full list, see last month's [beta announcement](/blog/2013/02/28/quest-5-4-beta-is-out-now).
