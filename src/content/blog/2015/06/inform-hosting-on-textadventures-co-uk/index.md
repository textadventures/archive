...
You can now upload games created with [Inform](http://inform7.com/) directly to textadventures.co.uk.
...
Just head to the "[Submit a Game](http://textadventures.co.uk/submit/submitfile)" link and submit your file. After uploading the file, enter a few basic details and hit Publish. That's it! Your game's listing page is created, where it can be played online (using [Parchment](https://github.com/curiousdannii/parchment)) or downloaded.
