...
I have been developing [Quest](https://github.com/textadventures/quest) and [textadventures.co.uk](http://textadventures.co.uk/) for a long time. It started off as a summer coding project when I was a teenager and wanted to send stupid text adventure games to a friend. Over the last couple of decades it has turned into something far bigger than I could have imagined.
...
If you're interested, please email me at [alex@textadventures.co.uk](mailto:alex@textadventures.co.uk).
...
- [Quest](https://github.com/textadventures/quest)
- [Squiffy](https://github.com/textadventures/squiffy)
- [QuestKit](https://github.com/textadventures/questkit)
- textadventures.co.uk:
    - The [site](http://textadventures.co.uk/) itself, where people can upload games (not just Quest and Squiffy games, but Inklewriter, Twine and Inform games too) and post reviews and comments
    - The [forums](http://textadventures.co.uk/forum)
    - Online player and editor for Quest games
    - Online editor for Squiffy
- [ActiveLit](http://activelit.com/)
- Social media accounts:
    - [@textadv](https://twitter.com/textadv)
    - [@activelit](https://twitter.com/activelit)
    - [facebook.com/textadventures](https://www.facebook.com/textadventures)
