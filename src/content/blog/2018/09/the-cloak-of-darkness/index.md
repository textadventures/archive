...
The Cloak of Darkness has its own [web site](http://www.firthworks.com/roger/cloak/) that at one time kept up to date with IF authoring systems and their implementation of it.

Unfortunately it has not been updated in well over a decade, and apparently that is not about to change. Quest is [on there](http://www.firthworks.com/roger/cloak/quest/index.html), but a very early version, 3.5, which is very much a different system. Back then, Quest had two programs, one that was free, to play games on, and the QuestPro version, which you had to pay for, and could be used to create games. The file format was also completely different.
...
I recently came across a thread on [intfiction.org](https://www.intfiction.org/forum/index.php) about the Cloak of Darkness (the first I had heard of it), and thought it would be interesting to do a modern version of it.
...
_**[The Second Quest Tutorial!](http://docs.textadventures.co.uk/quest/cloak_of_darkness.html)**_
