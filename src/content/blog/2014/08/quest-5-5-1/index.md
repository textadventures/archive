...
- New Grid\_DrawImage function to draw an image on the custom drawing grid
...
This release is now live for the [web version of Quest](http://textadventures.co.uk/create), and you can also [download the Windows version](http://textadventures.co.uk/quest/desktop).

Please [log any bugs you find on GitHub](https://github.com/textadventures/quest/issues).
