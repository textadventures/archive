...
I've just finished three improvements to how games are published on [textadventures.co.uk](http://www.textadventures.co.uk/):

**Publishing from the web version of Quest**

You can now publish games from the [web version of Quest](http://www.textadventures.co.uk/create/). From your game list, you can use the "Publish" link that appears next to your game. From the Editor itself, select "game" and hit the "Publish" button that appears in the top right of the screen.
...
The process for [uploading a game](http://www.textadventures.co.uk/submit-a-game/ "Submit a game") has been improved. The first step is to upload your file - after that, the game name, description and category you've specified in the Editor will be automatically extracted, so there's no need to enter this information again on the upload form.
