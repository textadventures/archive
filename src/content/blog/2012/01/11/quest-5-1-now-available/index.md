...
Quest 5.1 is [now available](http://www.textadventures.co.uk/quest510.exe).
...
- **Enhanced Game Browser**. You can now see star ratings, and read reviews and comments, directly within Quest. You also have more control - from the Options window, you can change the download folder, and enable or disable the Sandpit and Adult categories. Also, the Adult category option can be "locked out" with a registry setting ([see "Configuring Quest" on the wiki for details](http://quest5.net/wiki/Configuring_Quest)) - handy if you're rolling out Quest on a school network for example.
...
- **Walkthrough Enhancements**. You can now include walkthroughs in published .quest files, and the new walkthrough assertions feature allows you to create automated tests. See [Walkthrough Assertions](http://quest5.net/wiki/Walkthroughs#Assertions) on the wiki for details.
...
- **Hyperlinks**. You can now customise the look of hyperlink menus - change the menu fonts and colours, and turn link underlining on or off. It's now easier to create custom hyperlinks - the new [ObjectLink](http://quest5.net/wiki/ObjectLink) function makes it easier to create an object hyperlink, and the new [CommandLink](http://quest5.net/wiki/CommandLink) function lets you create a hyperlink that will run any command.
...
Full [upgrade notes are available on the wiki](http://quest5.net/wiki/Upgrade_Notes#Upgrading_from_Quest_5.0_to_Quest_5.1).

[**Download Quest 5.1**](http://www.textadventures.co.uk/quest510.exe)
