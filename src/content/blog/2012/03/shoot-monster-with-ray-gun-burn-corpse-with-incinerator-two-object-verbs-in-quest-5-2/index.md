...
![](/blogimages/2012/03/shoot-monster-with-ray-gun-burn-corpse-with-incinerator-two-object-verbs-in-quest-5-2/images/verbs1.png "Object verbs")
...
![](/blogimages/2012/03/shoot-monster-with-ray-gun-burn-corpse-with-incinerator-two-object-verbs-in-quest-5-2/images/verbs2.png "Adding a verb")

The next step is to set the verb option to "Require another object" - a new setting in Quest 5.2.

![](/blogimages/2012/03/shoot-monster-with-ray-gun-burn-corpse-with-incinerator-two-object-verbs-in-quest-5-2/images/verbs3.png "Require another object")

This will then give us an editor where we can add objects which can be used to the light the kindling.

![](/blogimages/2012/03/shoot-monster-with-ray-gun-burn-corpse-with-incinerator-two-object-verbs-in-quest-5-2/images/verbs4.png "Light kindling with match")

We can now set the script that runs when we light the kindling with the match:

![](/blogimages/2012/03/shoot-monster-with-ray-gun-burn-corpse-with-incinerator-two-object-verbs-in-quest-5-2/images/verbs51.png "Light kindling with match")

Finally, let's add "light" as a display verb for the kindling object, to make this verb usable with mouse or touchscreen.

![](/blogimages/2012/03/shoot-monster-with-ray-gun-burn-corpse-with-incinerator-two-object-verbs-in-quest-5-2/images/verbs6.png "Add display verb")
...
![](/blogimages/2012/03/shoot-monster-with-ray-gun-burn-corpse-with-incinerator-two-object-verbs-in-quest-5-2/images/verbs7.png "Light display verb")

Selecting this brings up a menu of things we can use to light the kindling with:

![](/blogimages/2012/03/shoot-monster-with-ray-gun-burn-corpse-with-incinerator-two-object-verbs-in-quest-5-2/images/verbs8.png "Light with which object?")
...
![](/blogimages/2012/03/shoot-monster-with-ray-gun-burn-corpse-with-incinerator-two-object-verbs-in-quest-5-2/images/verbs9.png "Result")
...
![](/blogimages/2012/03/shoot-monster-with-ray-gun-burn-corpse-with-incinerator-two-object-verbs-in-quest-5-2/images/verbs10.png "Verb defaults")
