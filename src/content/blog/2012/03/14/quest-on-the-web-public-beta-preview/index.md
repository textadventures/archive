...
[![](/blogimages/2012/03/14/quest-on-the-web-public-beta-preview/images/website1.png "Quest page")](http://www.textadventures.co.uk/quest/)
...
Quest was the first system to allow people to play text adventure games online (as far as I can tell - Quest has had this since [February 2007](/blog/2007/02/02/quest-games-online-beta), and I can't find any references to Parchment before 2008), and now it's the first _full_ text adventure editor to appear on the web (i.e. it's much more than a big text box!). Currently, about 10 times as many people play games through the web than download them to play offline, and I'm hoping that the new web-based editor will similarly increase the reach of Quest. It's not just about extending the editor to Mac, Linux, iPad, etc. - many people simply can't (or won't) install software even on Windows PCs.
